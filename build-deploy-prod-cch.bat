...
set NGINX_CONF=nginx-default.conf
...
scp %NGINX_CONF% %REMOTE_USER%@%REMOTE_HOST%:/etc/nginx/sites-available/default
...
echo 🌍 Your site should be live at: http://www.culturalheritage.coop
endlocal
pause
